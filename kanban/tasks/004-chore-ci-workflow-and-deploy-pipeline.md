...
- [ ] **Human action flagged:** enable branch protection on `main` (require PR, no direct/force push) — recorded in the card as a maintainer to-do.
...
**Notes**
Branch protection cannot be set by an agent — the closeout card (A-close) surfaces it as a human gate.
